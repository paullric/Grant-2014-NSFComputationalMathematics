...
%The CFL condition associated with these methods ranges from being equivalent to spectral element method to 33\% more costly, for a fixed order-of-accuracy.

% these methods have a slightly more restrictive maximum stable time step (CFL condition) which depends 
